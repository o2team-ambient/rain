(function (global, factory) {
  ...
  function () {
    ...
    createClass(Preloader, [{
      ...
      value: function updateProcess() {
        this.count++;
        var percent = Math.round(this.count / this.total * 100);
  ...
  function getRgba(color, opacity) {
    return "rgba(".concat(parseInt(color.slice(-6, -4), 16), ", ").concat(parseInt(color.slice(-4, -2), 16), ", ").concat(parseInt(color.slice(-2), 16), ", ").concat(opacity / 100, ")");
  }
  ...
  function () {
    ...
    createClass(Rain, [{
      ...
      key: "_loadImages",
      value: function _loadImages(cb) {
        var manifest = [];
        this.images.map(function (item, idx) {
          manifest.push({
            id: idx,
            src: item
          });
      ...
      key: "_getEaseFn",
      value: function _getEaseFn(ease) {
        var easeFn;
      ...
      key: "_setConf",
      value: function _setConf() {
        var conf = window[O2_AMBIENT_CONFIG];
      ...
      value: function _init() {
        ...
        this._loadImages(function () {
          _this.isCanvas ? _this._initCanvas() : _this._initDom();
          _this.isInit = true;
        });
      } // 初始化 canvas 模式
      ...
      value: function _initCanvas() {
        var domMain = document.querySelector('.o2team_ambient_main');
        var canvas = domMain.querySelector('canvas');
        this.canvas = canvas;
      ...
      key: "_setCanvasBg",
      value: function _setCanvasBg() {
        this.canvas.setAttribute('style', "background-color: ".concat(getRgba(this.bgColor, this.bgOpacity)));
      } // 设置 canvas 尺寸
      ...
      key: "_initDom",
      value: function _initDom() {} // 生成一个表情元素

    }, {
      key: "_createUnit",
      value: function _createUnit() {
        // 随机选择一个图片
        var idx = ~~(Math.random() * this.images.length);
        var isPositive = getRandomInt(0, 2);
        var img = new Image();
        img.src = this.images[idx];
        var imgWidth = img.width;
        var imgHeight = img.height; // 随机设置初始位置

        var posX = getRandomInt(0, this.windowWidth - imgWidth);
        var posY = -imgHeight;
        img.posX = posX;
        img.posY = posY;
      ...
      value: function _startAni() {
        ...
        if (this.isCanvas) {
          TweenMax.staggerTo(this.unitSet, this.durtaion, {
            posX: function posX(i, img) {
              return img.isPos ? img.posX + _this2.offset : img.posX - _this2.offset;
            },
            posY: function posY(i, img) {
              return _this2.ease === 'bounce' ? _this2.windowHeight - img.height : _this2.windowHeight;
            },
          ...
          TweenMax.ticker.addEventListener('tick', function () {
            ...
            _this2.unitSet.forEach(function (img) {
              _this2.ctx.drawImage(img, img.posX, img.posY, img.width, img.height);
            });
          });
        }
      } // 开始播放动画
  ...
  window[O2_AMBIENT_CONFIG] = {
    ...
    bgColor: '000000',
    bgOpacity: 0,
    textures: ['//img11.360buyimg.com/ling/s40x40_jfs/t18934/336/2145230261/6595/a1c52247/5ae921e6N79e26545.png', '//img30.360buyimg.com/ling/jfs/t18592/258/2135046772/2474/e4166c50/5ae921e6N7623e094.png', '//img10.360buyimg.com/ling/jfs/t18532/280/2176785009/1792/f7cc83e0/5ae921e6Nd84de3c1.png', '//img14.360buyimg.com/ling/jfs/t18775/80/2112504289/658/2b47a3d1/5ae921e6Ndc314839.png', '//img14.360buyimg.com/ling/jfs/t16747/303/2236365706/1123/bb04eee4/5ae921e6N481f83b2.png', '//img10.360buyimg.com/ling/jfs/t16639/109/2164752267/633/3a5c2c27/5ae921e6Nc0921505.png', '//img20.360buyimg.com/ling/jfs/t18970/64/2126101196/851/87281db2/5ae921e6N38d0ed61.png', '//img11.360buyimg.com/ling/s40x40_jfs/t19396/55/2198582218/17715/93071bdb/5ae921e6N3fa9bad1.png']
  };
